...
public class Entry {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("1. Add a new task record\n2. Display all tasks assigned to a specific employee\n3. Display tasks by status\n4. Display count of completed tasks per employee\n5. List all tasks sorted by assigned date\n6. Exit");
    ...
    public static void addNewTask() {
        try {
            ...
            // DuplicateTaskException to throw
            ...
            //getting appropriate task status
...
//     this is for existong tasks if any
